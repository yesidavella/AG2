...
public class ResultadosPhosphorousHTML {
    ...
    private ImageView ivIzq = new ImageView(new Image(getClass().getResourceAsStream("../../../../resource/image/mini_izquierda.png")));
    private ImageView ivDer = new ImageView(new Image(getClass().getResourceAsStream("../../../../resource/image/mini_derecha.png")));
    private ImageView ivDerFin = new ImageView(new Image(getClass().getResourceAsStream("../../../../resource/image/mini_derecha_fin.png")));
