...
public class OBS_SwicthGraphNode extends SwitchGraphNode
{
    ...
    public OBS_SwicthGraphNode(GrupoDeDiseno grupoDeDiseno,NodeAdminAbstractController controladorAbstractoAdminNodo,LinkAdminAbstractController ctrlAbsAdminEnlace) {
